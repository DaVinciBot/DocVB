...
- **Architecture Maître/Esclave** : Une **Raspberry Pi 5** embarquant la stratégie et la détection du robot adverse commande une carte **Teensy 4.1 (Teensy Moteur)** chargée de la cinématique et des asservissements matériels.
