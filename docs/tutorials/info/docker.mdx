...
description: Créer une application Node.js simple et la conteneuriser avec Docker — Dockerfile, construction d'image et exécution du conteneur.
slug: docker
...
## Étape 1 : Installation des outils nécessaires {/* #installation-des-outils-nécessaires */}
...
### 1.1 Télécharger le script d'installation de Docker {/* #télécharger-le-script-dinstallation-de-docker */}
...
### 1.2 Télécharger l'application d'exemple {/* #télécharger-lapplication-dexemple */}
...
### 1.3 Installer les outils supplémentaires {/* #installer-les-outils-supplémentaires */}
...
### 1.4 Installer Docker {/* #installer-docker */}
...
### 1.5 Décompresser l'application {/* #décompresser-lapplication */}

```bash
unzip app.zip
```

## Étape 2 : Comprendre le Dockerfile {/* #comprendre-le-dockerfile */}

Créons un fichier `Dockerfile` à la racine de notre projet. Ce fichier décrit comment construire notre image Docker.

### 2.1 Créer le Dockerfile {/* #créer-le-dockerfile */}
...
### 2.2 Contenu du Dockerfile {/* #contenu-du-dockerfile */}
...
### 2.3 Explication du Dockerfile ligne par ligne {/* #explication-du-dockerfile-ligne-par-ligne */}
...
## Étape 3 : Construire l'image Docker {/* #construire-limage-docker */}

Maintenant que notre Dockerfile est prêt, construisons notre image Docker.

### 3.1 Commande de build {/* #commande-de-build */}
...
### 3.2 Vérifier l'image créée {/* #vérifier-limage-créée */}
...
## Étape 4 : Exécuter le conteneur {/* #exécuter-le-conteneur */}

### 4.1 Lancer le conteneur {/* #lancer-le-conteneur */}
...
### 4.4 Exécuter en arrière-plan {/* #exécuter-en-arrière-plan */}
...
## Étape 5 : Docker Compose (Avancé) {/* #docker-compose-avancé */}

Pour des applications plus complexes avec plusieurs services, on utilise Docker Compose.

### 5.1 Créer docker-compose.yml {/* #créer-docker-composeyml */}

```bash
micro docker-compose.yml
```

### 5.2 Configuration avec PostgreSQL {/* #configuration-avec-postgresql */}
...
### 5.3 Explication de Docker Compose {/* #explication-de-docker-compose */}
...
### 5.4 Créer le fichier de secrets {/* #créer-le-fichier-de-secrets */}
...
### 5.5 Lancer avec Docker Compose {/* #lancer-avec-docker-compose */}
...
### 5.6 Vérifier les services {/* #vérifier-les-services */}
...
### 5.7 Arrêter tous les services {/* #arrêter-tous-les-services */}
...
### Nettoyage complet {/* #nettoyage-complet */}
