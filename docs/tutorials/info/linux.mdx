...
description: Les bases de Linux en ligne de commande — navigation, manipulation de fichiers, permissions, utilisateurs/groupes et processus.
slug: linux
tags: [info, sysadmin, linux]
last_update:
  date: 2025-10-21
...
## Étape 1 — Se repérer et naviguer {/* #se-repérer-et-naviguer */}
...
## Étape 2 — Lire et chercher dans des fichiers {/* #lire-et-chercher-dans-des-fichiers */}
...
## Étape 3 — Créer, copier, déplacer, renommer {/* #créer-copier-déplacer-renommer */}
...
## Étape 4 — Supprimer en sécurité {/* #supprimer-en-sécurité */}
...
## Étape 5 — Comprendre et modifier les permissions {/* #comprendre-et-modifier-les-permissions */}
...
## Étape 6 — Utilisateurs et groupes {/* #utilisateurs-et-groupes */}
...
## Étape 7 — Processus et gestion des tâches {/* #processus-et-gestion-des-tâches */}
...
## Étape 8 — Aide intégrée et documentation {/* #aide-intégrée-et-documentation */}
...
## Étape 9 — Redirections, pipes et flux {/* #redirections-pipes-et-flux */}
...
## Étape 10 — Archives et transferts utiles {/* #archives-et-transferts-utiles */}
