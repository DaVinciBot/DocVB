...
![Fenêtre Unity Hub listant les projets existants](./images/unity/01-unity-hub.png)
...
![Schéma des zones Hierarchy, Scene, Game, Inspector et Project de l'éditeur Unity](./images/unity/02-reperes-interface-unity.png)
_Les zones principales de l'éditeur Unity._

![Éditeur Unity ouvert sur une scène vide avec ses panneaux](./images/unity/03-scene-unity-vide.png)
...
![Panneau Hierarchy contenant Main Camera et Directional Light](./images/unity/04-hierarchy-scene-vide.png)
_Dans la Hierarchy, une scène vide contient souvent Main Camera et Directional Light._

![Vue Scene avec l'icône caméra de la Main Camera sélectionnée](./images/unity/05-scene-main-camera.png)
_Dans Scene, l'icône caméra permet de repérer l'objet Main Camera._

![Vue Game affichant le rendu de la caméra](./images/unity/06-game-view.png)
...
![Dossier Assets contenant Editor, Materials, Scenes et Scripts](./images/unity/07-organisation-assets.png)
...
![Menu contextuel Create ouvert dans le dossier Assets](./images/unity/08-menu-create.png)
...
![Menu contextuel 3D Object > Cube dans la Hierarchy](./images/unity/09-creation-cube.png)
_Création d'un cube depuis la Hierarchy._

![Schéma d'un GameObject et de ses composants Transform, Mesh Renderer, Box Collider, Rigidbody et script C#](./images/unity/10-gameobject-composants.png)
...
![Inspector d'un cube affichant Transform, Mesh Renderer et Box Collider](./images/unity/11-inspector-cube.png)
...
![Menu Create > Material dans le dossier Assets](./images/unity/12-creation-material.png)
_Création d'un Material depuis le dossier Assets._

![Inspector d'un Material orange avec son aperçu sphérique](./images/unity/13-material-orange.png)
...
![Comparaison avant/après de l'application d'un Material orange sur un cube](./images/unity/14-material-avant-apres.png)
...
![Menu Window avec l'entrée Package Manager](./images/unity/15-window-package-manager.png)
_Ouverture du Package Manager depuis Window > Package Manager._

![Package Manager affichant le paquet Visual Studio Code Editor](./images/unity/16-package-visual-studio-code-editor.png)
...
![Bouton Add Component en bas de l'Inspector](./images/unity/17-add-component.png)
_Le bouton Add Component ajoute un composant à l'objet sélectionné._

![Liste des catégories de composants proposées par Add Component](./images/unity/18-categories-composants.png)
_Add Component donne accès aux catégories de composants Unity._

![Recherche « script » dans Add Component avec l'entrée New script](./images/unity/19-recherche-script.png)
...
![Composant Rigidbody dans l'Inspector avec Mass, Drag, Use Gravity et Constraints](./images/unity/20-rigidbody.png)
...
![Schéma comparant un Collider normal bloquant et un Trigger traversable](./images/unity/21-collider-vs-trigger.png)
_Différence entre Collider et Trigger : collision bloquante ou détection sans blocage._

![Comparaison avant/après montrant la plaque de pression qui ouvre la porte](./images/unity/22-trigger-plaque-porte.png)
...
![Schéma d'un raycast vert détectant un sol et d'un raycast rouge dans le vide](./images/unity/23-raycast-sol.png)
...
![Vue d'ensemble du niveau de plateforme dans l'éditeur Unity](./images/unity/24-niveau-plateforme.png)
