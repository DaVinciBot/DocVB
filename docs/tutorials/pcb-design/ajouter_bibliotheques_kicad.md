...
## 4. Ajouter une bibliothèque depuis des fichiers locaux (projet ou disque) {/*#ajouter-une-bibliothèque-depuis-des-fichiers-locaux-projet-ou-disque*/}
...
## 5. Ajouter une bibliothèque depuis un dépôt Git (lecture seule ou clone) {/*#ajouter-une-bibliothèque-depuis-un-dépôt-git-lecture-seule-ou-clone*/}
