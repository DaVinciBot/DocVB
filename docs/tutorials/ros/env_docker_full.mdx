---
title: Formation rapide — Utiliser l'environnement ROS2 (devContainer)
description: Formation rapide à l'environnement de développement ROS2 en devContainer — installation Windows (WSL2) et Linux, compilation et lancement de la simulation Gazebo + RViz2.
slug: env-docker-full
sidebar_label: Comment utiliser l'environnement ROS2 de DVB
tags: [info, ros2, gazebo, docker]
last_update:
  date: 2025-11-13
...
## Installation rapide — Windows (WSL2 + Docker Desktop + VS Code) {/* #installation-rapide--windows-wsl2--docker-desktop--vs-code */}

### Activer et installer WSL2 {/* #activer-et-installer-wsl2 */}
...
### Installer VS Code et extensions recommandées {/* #installer-vs-code-et-extensions-recommandées */}
...
### Flux de travail recommandé (Windows) {/* #flux-de-travail-recommandé-windows */}
...
## Installation rapide — Linux (ex. Ubuntu) {/* #installation-rapide--linux-ex-ubuntu */}
...
### Flux de travail (Linux) {/* #flux-de-travail-linux */}
...
## Utilisation dans le devContainer {/* #utilisation-dans-le-devcontainer */}
...
### Lancer la simulation (Gazebo + RViz2) {/* #lancer-la-simulation-gazebo--rviz2 */}

```bash
ros2 launch main_rover launch_sim.launch.py
```

## Notes et conseils pratiques {/* #notes-et-conseils-pratiques */}
...
## Prochaine étape suggérée {/* #prochaine-étape-suggérée */}
